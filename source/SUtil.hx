...
class SUtil
{
	...
	public static function doTheCheck()
	{
		...
		{
		    for (Exc in ['READ_EXTERNAL_STORAGE', 'WRITE_EXTERNAL_STORAGE'])
			AndroidPermissions.requestPermission(Exc);
	...
	{
		AndroidTools.showAlertDialog(title, description, {name: "OK", func: null}, null);
	}
